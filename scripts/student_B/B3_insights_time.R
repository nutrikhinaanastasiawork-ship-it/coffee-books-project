...
# Проценты
revenue_diff_pct <- round((best_day$revenue - worst_day$revenue) / worst_day$revenue * 100, 1)
check_diff_pct <- round((best_check$avg_check - worst_check$avg_check) / worst_check$avg_check * 100, 1)
...
insights <- paste0(
  ...
  "Разница составляет ", format(best_day$revenue - worst_day$revenue, big.mark = " "), " рублей (", revenue_diff_pct, "%).\n",
  ...
  "Разница составляет ", round(best_check$avg_check - worst_check$avg_check, 0), " рублей (", check_diff_pct, "%).\n",
  ...
  "Разница составляет всего ", round(weekend_avg - weekday_avg, 0), " рублей (", weekend_diff_pct, "%), что статистически незначительно.\n",
